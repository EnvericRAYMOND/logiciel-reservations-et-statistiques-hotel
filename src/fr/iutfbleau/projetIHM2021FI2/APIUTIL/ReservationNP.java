...
public class ReservationNP implements Reservation {
    ...
    public String monPrint() {
        return String.format("Réservation " + getReference() + ": " + getClient().monPrint() + " le " +  getDateDebut().toString() + " pour " + getJours() + " nuit(s) et dans la chambre "+getChambre().getNumero());
    }
